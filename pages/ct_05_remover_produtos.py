...
class RemoverProdutos(BasePage):
    def __init__(self):
    ...
    def remover_produtos(self):
        ...
        # mensagem_removido_do_carrinho = WebDriverWait(self.driver, 10).until(
        #     EC.element_to_be_clickable(
        #         (By.XPATH, "//button[@class='btn btn_secondary btn_small cart_button'][contains(.,'Remove')]"))).text
        # assert mensagem_removido_do_carrinho == "Remove"
        # print("Produto removido do carrinho.")
